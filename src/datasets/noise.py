...
import sys
sys.path.append('/data/haoyuan/ZSCL/mtil/src')
...
import sys
sys.path.append('/data/haoyuan/ZSCL')
from mtil.src.datasets.common import ImageFolderWithPaths, SubsetSampler
from mtil.src.templates.openai_imagenet_template import openai_imagenet_template
from mtil.src.datasets.imagenet_classnames import get_classnames
from mtil.src.datasets.imagenet import ImageNet, ImageNetSubsampleValClasses
